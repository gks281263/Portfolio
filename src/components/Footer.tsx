...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/gks281263',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/gauravkumar7777/',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    <footer className="bg-dark-lighter py-12">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold text-primary mb-4">Gaurav Kumar</h3>
            <p className="text-gray-300 mb-4">
              Building secure and efficient solutions for tomorrow's digital challenges.
            </p>
            <a
              href="/Portfolio/GCV.pdf"
              download
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center px-5 py-2 rounded-lg bg-primary text-primary-foreground font-semibold shadow-lg hover:bg-primary/80 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 mb-2"
            >
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#certifications" className="text-gray-300 hover:text-primary transition-colors">Certifications</a></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {currentYear} Gaurav Kumar. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
